...
@section('title','Kriteria Fasilitas')
@section('content')
<div class="container-fluid" id="container-wrapper">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Kriteria Fasilitas</h1>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="#">Master</a></li>
            <li class="breadcrumb-item active" aria-current="page">Kriteria Fasilitas</li>
        </ol>
    </div>
    <div class="row">
        <div class="col-lg-12">
            <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-primary">Data Kriteria Fasilitas</h6>
...
@include('pages.kriteria-fasilitas.modal')
</div>
<script type="application/javascript">
    $(document).ready(function () {
        $('#kriterias_table').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "{{ route('kriteria-fasilitas.index') }}",
                type: 'GET',
            },
            "responsive": false,
        ...
        $('#add-btn').click(function () {
            ...
            $('#modal-judul').html("Tamba Kriteria Fasilitas");
        ...
        $("#form-create").on('submit', function (e) {
            ...
            $.ajax({
                url: "{{ route('kriteria-fasilitas.store')}}",
                type: "POST",
                data: formData,
                cache: false,
                contentType: false,
    ...
    function updateItem(e) {
        ...
        $.ajax({
            type: 'GET',
            url:  '/kriteria-fasilitas/' + id + '/edit',
            success: function (response) {
                $('#id').val(response.id);
