...
@section('title','Kriteria Rasa')
@section('content')
<div class="container-fluid" id="container-wrapper">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Kriteria Rasa</h1>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="#">Master</a></li>
            <li class="breadcrumb-item active" aria-current="page">Kriteria Rasa</li>
        </ol>
    </div>
    <div class="row">
        <div class="col-lg-12">
...
@include('pages.kriteria-rasa.modal')
</div>
