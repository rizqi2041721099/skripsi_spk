...
@section('title','Kriteria Jam Operasional')
@section('content')
<div class="container-fluid" id="container-wrapper">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Kriteria Jam Operasional</h1>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="#">Master</a></li>
            <li class="breadcrumb-item active" aria-current="page">Kriteria Jam Operasional</li>
        </ol>
    </div>
    <div class="row">
        <div class="col-lg-12">
            <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-primary">Data Kriteria Jam Operasional</h6>
...
@include('pages.kategori-jam-operasional.modal')
</div>
<script type="application/javascript">
    $(document).ready(function () {
        $('#kriterias_table').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "{{ route('kriteria-jam-operasional.index') }}",
                type: 'GET',
            },
            "responsive": false,
        ...
        $('#add-btn').click(function () {
            ...
            $('#modal-judul').html("Tambah Kategori Jam Operasional");
        ...
        $("#form-create").on('submit', function (e) {
            ...
            $.ajax({
                url: "{{ route('kriteria-jam-operasional.store')}}",
                type: "POST",
                data: formData,
                cache: false,
                contentType: false,
        ...
        $('#form-edit').on('submit', function (event) {
            ...
            $.ajax({
                url: 'kriteria-jam-operasional/' + id,
                type: "POST",
                data: formData,
                cache: false,
                contentType: false,
    ...
    function updateItem(e) {
        ...
        $.ajax({
            type: 'GET',
            url:  '/kriteria-jam-operasional/' + id + '/edit',
            success: function (response) {
                $('#id').val(response.id);
