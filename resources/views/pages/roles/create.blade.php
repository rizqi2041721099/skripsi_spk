    ...
    <div class="container-fluid" id="container-wrapper">
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="#">Tambah Role</a></li>
            </ol>
        </div>
        <div class="card mb-3" style="margin-top: -20px !important">
            ...
            <div class="card-body">
                <form id="roles-form">
                    @csrf
                    <div class="row mb-3">
                        <label for="name" class="col-2 col-form-label">Name
                    ...
                    <div class="row mb-3">
                        <legend class="col-form-label col-2 pt-0">Permissions <span class="text-danger">*</span>
                        </legend>
                        <div class="col-10">
                            <div class="row">
                                <div class="col">
