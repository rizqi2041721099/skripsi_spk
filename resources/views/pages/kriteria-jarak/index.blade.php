...
@section('title','Kriteria Jarak')
@section('content')
<div class="container-fluid" id="container-wrapper">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Kriteria Jarak</h1>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="#">Master</a></li>
            <li class="breadcrumb-item active" aria-current="page">Kriteria Jarak</li>
        </ol>
    </div>
    <div class="row">
        <div class="col-lg-12">
            <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-primary">Data Kriteria Jarak</h6>
...
@include('pages.kriteria-jarak.modal')
</div>
<script type="application/javascript">
    $(document).ready(function () {
        $('#kriterias_table').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "{{ route('kriteria-jarak.index') }}",
                type: 'GET',
            },
            "responsive": false,
        ...
        $("#form-create").on('submit', function (e) {
            ...
            $.ajax({
                url: "{{ route('kriteria-jarak.store')}}",
                type: "POST",
                data: formData,
                cache: false,
                contentType: false,
